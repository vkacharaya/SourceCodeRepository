...
void Message::user(const std::string& userName)
{
	attributes_["user"] = userName;
}
...
std::string Message::user()
{
	if (containsKey("user"))
	{
		return attributes_["user"];
	}
	return "";
}

std::string Message::nameSP()
{
	if (containsKey("nameSP"))
	{
		return attributes_["nameSP"];
	}
	return "";
}

void Message::nameSP(const std::string& nm)
{
	attributes_["nameSP"] = nm;
}
//----< set name attribute >-------------------------------------------
...
void Message::path(const std::string& path)
{
...
std::string Message::filter()
{
	...
	{
		return attributes_["filter"];
	}
	return "";
}

//----< set file name attribute >--------------------------------------
void Message::filter(const std::string& fl)
{
	attributes_["filter"] = fl;
}
...
*/
std::ostream& Message::show(std::string message, std::ostream& out)
{
	out  << message;
	out << "\n  _________________________________________________________________________________________________";
	for (auto atrib : this->attributes_)
	{
		out << "\n";
		out << "  " << std::setw(20) << std::left << atrib.first;
		out << "  " << std::setw(20) << std::left << atrib.second;
	}
