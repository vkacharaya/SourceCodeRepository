...
namespace MsgPassingCommunication
{
	...
	public:
		...
		////////////////////////////////////////////////////////////////////////////////
		// Parse server message in human readable format
		void show(String^ headerMsg)
		{
			headerMsg = "\n______________________________________________________________________________";
			headerMsg = headerMsg + "\nRequest Message sent from Client can be seen in the server console.";
			headerMsg = headerMsg + "\nResponse Message from Server found below. Check command attribute for requirement\n";

			headerMsg = headerMsg + "______________________________________________________________________________";
